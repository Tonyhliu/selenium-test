...
var Page = function() {
    ...
    this.findByClassName = async function(className) {
        await this.driver.wait(until.elementLocated(By.className(className)));
        // await this.driver.wait(until.elementLocated(By.className(className)), 15000, 'Looking for element by CLASSNAME');
    ...
    this.findByCSS = async function(css) {
        await this.driver.wait(until.elementLocated(By.css(css)));
